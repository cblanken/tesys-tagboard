...
Here you will find all the instructions for configuration and deploying
your own instance of Tesy’s Tagboard.
...
Setup one of the supported `email providers`_ or use your own SMTP
server.
